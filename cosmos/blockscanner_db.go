...
func (bs *ATOMBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *ATOMBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *ATOMBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *ATOMBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *ATOMBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *ATOMBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *ATOMBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
